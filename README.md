...
> 基于 SQL + Power BI 的零售财务分析项目,构建"吊牌额→促销折扣→会员折扣→实际收入"四层收入结构模型,搭建 5 页可视化看板支撑收入质量监控与折扣策略决策。
...
模拟连锁零售企业的财务分析场景,基于销售订单、商品、会员、门店、品类等多源数据,通过 SQL 加工与 Power BI 可视化,建立一套覆盖**收入质量监控、折扣结构拆解、门店对标、会员价值、商品价值分析**的财务分析体系。
...
#### 页面4:会员价值分析
![页面4](05_看板截图_单页/页面4_会员价值分析.png)

#### 页面5:商品价值分析
![页面5](05_看板截图_单页/页面5_商品价值分析.png)
...
- **时间对比(多项)**:基于 MTD 的 MoM 环比、日环比、上期对比指标

实现方式:25+ 个 DAX 度量值,详见 `04_可视化看板/零售连锁企业收入质量与折扣管控看板.pbix`

---

## 🚀 快速浏览

**如果你只有 30 秒**:直接看上面"看板预览"的 5 张截图

**如果你只有 5 分钟**:浏览本 README 完整内容

**如果你想深入了解**:阅读 [01_项目说明文档.md](01_项目说明文档.md)

**如果你想交互体验**:下载 [零售连锁企业收入质量与折扣管控看板.pbix](04_可视化看板/零售连锁企业收入质量与折扣管控看板.pbix),需要 Power BI Desktop(免费,[微软官方下载](https://powerbi.microsoft.com/zh-cn/desktop/))
